...
$KW.Segment = (function() {
    ...
    var module = {
        ...
        setRowFocusSkinForRetainedSelection: function (element, widgetModel) {
            element.classList.add(widgetModel.rowFocusSkin);
            element.classList.remove(widgetModel.rowskin);
        },
        ...
        setFocus: function(widgetModel, element, selectedindex) {
            ...
            (element && widgetModel.height) && $KW.APIUtils.setfocus(widgetModel, null, element);
            
            
            if (element && widgetModel.retainselection && widgetModel.viewtype == constants.SEGUI_VIEW_TYPE_TABLEVIEW && widgetModel.rowFocusSkin) {
                this.setRowFocusSkinForRetainedSelection(element, widgetModel);
            }
        },
