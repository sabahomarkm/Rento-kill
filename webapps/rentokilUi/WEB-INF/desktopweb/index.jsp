...
if (document.getElementById && document.createElement) {
    ...
    if (top != self) {
        top.location = self.location;
             ...
             <link rel="stylesheet" href="desktopweb/jslib/tparty/libraries/ServiceBookingWidget/widget.css?ver=1.0.0" type="text/css" /></link>
          
   
 
   
          
             <script type="text/javascript" src="desktopweb/jslib/tparty/libraries/ServiceBookingWidget/widget.js?ver=1.0.0"></script>
          
   
          
             <script type="text/javascript" src="desktopweb/jslib/tparty/widgets/servicePage/tp-servicePage-wrapper.js?ver=1.0.0"></script>
